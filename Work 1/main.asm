...
# Trabalho realizado pelos alunos: Mathias Recktenvald e Guilherme Brizzi
...
print_unknown:
	########################
	# imprime "Instrução desconhecida"
...
print_register:
	...
	move $t9, $a0		# $t9 recebe o valor em $a0 (registrador parametro)
...
decode_instruction:
	...
	op_0:
		...
		beq $t1, 8, op_jr		# se funct = 0x8, goto op_jr
		j default
